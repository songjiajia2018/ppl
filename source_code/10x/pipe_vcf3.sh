...
samtools view -@ 15 -bS Endothelial.sam > Endothelial.bam
samtools sort -@ 15 Endothelial.bam -o Endothelial.sorted.bam
samtools index -@ 15  Endothelial.sorted.bam
bcftools mpileup -Q 30 -A -x -Ou -r MT -f /home/songjia/reference/human/Homo_sapiens.GRCh38.dna.primary_assembly.fa --threads 15 Endothelial.sorted.bam |bcftools call --threads 15 -mv > Endothelial.vcf
samtools view -@ 15 -bS Acinar_like.sam > Acinar_like.bam
samtools sort -@ 15 Acinar_like.bam -o Acinar_like.sorted.bam
samtools index -@ 15  Acinar_like.sorted.bam
bcftools mpileup -Q 30 -A -x -Ou -r MT -f /home/songjia/reference/human/Homo_sapiens.GRCh38.dna.primary_assembly.fa --threads 15 Acinar_like.sorted.bam |bcftools call --threads 15 -mv > Acinar_like.vcf
