#! /bin/bash
cd ./97/
cellranger count --id=97 --transcriptome=/home/songjia/reference/human/cellranger/GRCh38 --fastqs=/home/songjia/songjiajia/genome_biology/97 --expect-cells=10000 --localcores=20
cd ./97/outs/
